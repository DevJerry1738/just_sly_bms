...
const cardVariants = cva(
  "rounded-xl border bg-card text-card-foreground transition-all duration-150",
  {
    variants: {
      variant: {
        default: "border-border shadow-2xs",
        flat: "border-border shadow-none bg-card",
        elevated: "border-border shadow-sm hover:shadow-md",
        interactive: "border-border shadow-2xs hover:border-border/80 hover:bg-accent/40 cursor-pointer",
